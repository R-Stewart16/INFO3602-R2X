          ...
          <div class="dropdown">
            <ul>
              ...
              <li <?php if(get_post_type() == 'post') ?>>
                    <a class="dropdownlink" href="<?php echo site_url('/about-us');?>">About Us</a>
                    <div class="dropdown-content">
                      <a href="<?php echo site_url('/our-team');?>">Our Team</a>
                      <a href="<?php echo site_url('/barber-salon-policies');?>">R^2X Policy</a>
                    </div>
              </li>
              <li <?php if(get_post_type() == 'service')?>>
                    <a class="dropdownlink" href="<?php echo get_post_type_archive_link('services');?>">Our Services</a>
                    <div class="dropdown-content">
              ...
              <li <?php if(get_post_type() == 'post')?>>
                    <a class="dropdownlink" href="<?php echo site_url('/legal');?>">Legal</a>
                    <div class="dropdown-content">
                      <a href="<?php echo site_url('/privacy-policy');?>">Privacy Policy</a>
                      <a href="<?php echo site_url('/appointment-policy');?>">Appointment Policy</a>
                      <a href="<?php echo site_url('/payment-policy');?>">Payment Policy</a>
                    </div>
               </li>
