...
<?php 
  ...
  the_author_posts_link();?> on <?php the_time('n.j.y'); ?>
  ...
  <div class="service-box wow bounceInDown delay-1000" data-wow-duration="2s">
          ...
          <div class="col-lg-2 col-md-2 pdate">
            <div class="datebox">
              <div class="date-monthwrap">
                <span class="date-month"><a href="<?php echo esc_url( get_day_link( $vw_hair_salon_archive_year, $vw_hair_salon_archive_month, $vw_hair_salon_archive_day)); ?>"><?php echo esc_html( get_the_date( 'M' ) ); ?><span class="screen-reader-text"><?php echo esc_html( get_the_date() ); ?></span></a></span>

                <span class="date-day"><a href="<?php echo esc_url( get_day_link( $vw_hair_salon_archive_year, $vw_hair_salon_archive_month, $vw_hair_salon_archive_day)); ?>"><?php echo esc_html( get_the_date( 'd') ); ?><span class="screen-reader-text"><?php echo esc_html( get_the_date() ); ?></span></a></span>
              </div>
              <div class="yearwrap">
                <span class="date-year"><a href="<?php echo esc_url( get_day_link( $vw_hair_salon_archive_year, $vw_hair_salon_archive_month, $vw_hair_salon_archive_day)); ?>"><?php echo esc_html( get_the_date( 'Y' ) ); ?><span class="screen-reader-text"><?php echo esc_html( get_the_date() ); ?></span></a></span>
              </div>
            </div>
          </div> 
        <?php } ?>
           ...
           <h2 class="section-title"><a href="<?php echo esc_url( get_permalink() ); ?>" title="<?php echo the_title_attribute(); ?>"><?php the_title();?><span class="screen-reader-text"><?php the_title(); ?></span></a></h2>     
            <div class="new-text">
              <div class="entry-content">
                <p>
                  <?php $vw_hair_salon_theme_lay = get_theme_mod( 'vw_hair_salon_excerpt_settings','Excerpt');
                  if($vw_hair_salon_theme_lay == 'Content'){ ?>
                    <?php the_content(); ?>
                  <?php }
                  if($vw_hair_salon_theme_lay == 'Excerpt'){ ?>
    ...
    <?php }else if($vw_hair_salon_theme_lay == 'Center'){ ?>
      <div class="new-text">
        ...
        <?php } ?>
        <?php if( get_theme_mod( 'vw_hair_salon_featured_image_hide_show',true) != '') { ?>
          <div class="box-image">
