<?php
	...
	if($vw_hair_salon_first_color != false){
		$vw_hair_salon_custom_css .='.extra-top, .top-bar i, .search-box i, .slider .carousel-control-prev-icon, .slider .carousel-control-next-icon, .slider .carousel-control-prev-icon:hover, .slider .carousel-control-next-icon:hover, .more-btn a, .scrollup i, input[type="submit"], .footer-2, .sidebar input[type="submit"], nav.woocommerce-MyAccount-navigation ul li, .woocommerce .cart .button, .woocommerce .cart input.button:hover, .woocommerce a.button:hover, .woocommerce ul.products li.product .button:hover, .woocommerce #respond input#submit.alt:hover, .woocommerce a.button.alt:hover, .woocommerce button.button.alt:hover, .woocommerce input.button.alt:hover button.single_add_to_cart_button.button.alt:hover, .woocommerce #respond input#submit:hover, .woocommerce a.button:hover, .woocommerce button.button:hover, .woocommerce input.button:hover, .date-monthwrap, .hvr-sweep-to-right:before, .pagination span, .pagination a,.sidebar .tagcloud a:hover,.footer .tagcloud a:hover, .toggle-nav i, .sidebar .woocommerce-product-search button, .sidebar .widget_price_filter .ui-slider .ui-slider-range, .sidebar .widget_price_filter .ui-slider .ui-slider-handle, .footer .widget_price_filter .ui-slider .ui-slider-range, .footer .widget_price_filter .ui-slider .ui-slider-handle, .footer .woocommerce-product-search button, .footer a.custom_read_more, .sidebar a.custom_read_more:hover, .footer .custom-social-icons i:hover, .sidebar .custom-social-icons i:hover, .nav-previous a, .nav-next a, .woocommerce nav.woocommerce-pagination ul li a, .email span a, #preloader, .footer .wp-block-search .wp-block-search__button, .sidebar .wp-block-search .wp-block-search__button{';
			$vw_hair_salon_custom_css .='background-color: '.esc_attr($vw_hair_salon_first_color).';';
		$vw_hair_salon_custom_css .='}';
	}
	if($vw_hair_salon_first_color != false){
	...
	if($vw_hair_salon_first_color != false){
		$vw_hair_salon_custom_css .='.footer .search-form .search-field, .woocommerce a.button:hover, .woocommerce ul.products li.product .button:hover, .woocommerce #respond input#submit.alt:hover, .woocommerce a.button.alt:hover, .woocommerce button.button.alt:hover, .woocommerce input.button.alt:hover button.single_add_to_cart_button.button.alt:hover, .post-main-box:hover, .toggle-nav i, .footer a.custom_read_more:hover, .footer .custom-social-icons i, .sidebar .custom-social-icons i, .footer .custom-social-icons i:hover, .sidebar .custom-social-icons i:hover{';
			$vw_hair_salon_custom_css .='border-color: '.esc_attr($vw_hair_salon_first_color).';';
		$vw_hair_salon_custom_css .='}';
	}
	if($vw_hair_salon_first_color != false){
		$vw_hair_salon_custom_css .='.slider, .main-navigation ul ul{';
			$vw_hair_salon_custom_css .='border-top-color: '.esc_attr($vw_hair_salon_first_color).';';
		$vw_hair_salon_custom_css .='}';
	}
	if($vw_hair_salon_first_color != false){
		$vw_hair_salon_custom_css .='.slider, .main-navigation ul ul{';
			$vw_hair_salon_custom_css .='border-bottom-color: '.esc_attr($vw_hair_salon_first_color).';';
		$vw_hair_salon_custom_css .='}';
	}
    ...
    if($vw_hair_salon_theme_lay == 'Boxed'){
		...
		$vw_hair_salon_custom_css .='.scrollup i{';
			$vw_hair_salon_custom_css .='right: 100px;';
		$vw_hair_salon_custom_css .='}';
		$vw_hair_salon_custom_css .='.scrollup.left i{';
		  $vw_hair_salon_custom_css .='left: 100px;';
		$vw_hair_salon_custom_css .='}';
		$vw_hair_salon_custom_css .='.email{';
		  $vw_hair_salon_custom_css .='padding: 8px 0px 0px 10px;';
		$vw_hair_salon_custom_css .='}';
		...
		$vw_hair_salon_custom_css .='}';
		$vw_hair_salon_custom_css .='.scrollup i{';
			$vw_hair_salon_custom_css .='right: 30px;';
		$vw_hair_salon_custom_css .='}';
		$vw_hair_salon_custom_css .='.scrollup.left i{';
		  $vw_hair_salon_custom_css .='left: 30px;';
		$vw_hair_salon_custom_css .='}';
	...
	$vw_hair_salon_slider_content_padding_top_bottom = get_theme_mod('vw_hair_salon_slider_content_padding_top_bottom');
	$vw_hair_salon_slider_content_padding_left_right = get_theme_mod('vw_hair_salon_slider_content_padding_left_right');
	if($vw_hair_salon_slider_content_padding_top_bottom != false || $vw_hair_salon_slider_content_padding_left_right != false){
		$vw_hair_salon_custom_css .='.slider .carousel-caption{';
			$vw_hair_salon_custom_css .='top: '.esc_attr($vw_hair_salon_slider_content_padding_top_bottom).'; bottom: '.esc_attr($vw_hair_salon_slider_content_padding_top_bottom).';left: '.esc_attr($vw_hair_salon_slider_content_padding_left_right).';right: '.esc_attr($vw_hair_salon_slider_content_padding_left_right).';';
		$vw_hair_salon_custom_css .='}';
	}
	...
	if($vw_hair_salon_slider_height != false){
		$vw_hair_salon_custom_css .='.slider img{';
			$vw_hair_salon_custom_css .='height: '.esc_attr($vw_hair_salon_slider_height).';';
		$vw_hair_salon_custom_css .='}';
	}
	...
	if($vw_hair_salon_resp_topbar == true && get_theme_mod( 'vw_hair_salon_topbar_hide_show', false) == false){
	...
	if($vw_hair_salon_resp_stickyheader == true && get_theme_mod( 'vw_hair_salon_sticky_header',false) != true){
    	$vw_hair_salon_custom_css .='.header-fixed{';
			$vw_hair_salon_custom_css .='position:static;';
		$vw_hair_salon_custom_css .='} ';
	}
    if($vw_hair_salon_resp_stickyheader == true){
    	$vw_hair_salon_custom_css .='@media screen and (max-width:575px) {';
		$vw_hair_salon_custom_css .='.header-fixed{';
			$vw_hair_salon_custom_css .='position:fixed;';
		$vw_hair_salon_custom_css .='} }';
	...
	if($vw_hair_salon_resp_slider == true && get_theme_mod( 'vw_hair_salon_slider_hide_show', false) == false){
	...
	if($vw_hair_salon_resp_scroll_top == true && get_theme_mod( 'vw_hair_salon_hide_show_scroll',true) != true){
    	$vw_hair_salon_custom_css .='.scrollup i{';
			$vw_hair_salon_custom_css .='visibility:hidden !important;';
		$vw_hair_salon_custom_css .='} ';
	}
    if($vw_hair_salon_resp_scroll_top == true){
    	$vw_hair_salon_custom_css .='@media screen and (max-width:575px) {';
		$vw_hair_salon_custom_css .='.scrollup i{';
			$vw_hair_salon_custom_css .='visibility:visible !important;';
		$vw_hair_salon_custom_css .='} }';
	...
	if($vw_hair_salon_topbar_padding_top_bottom != false){
		$vw_hair_salon_custom_css .='.extra-top{';
			$vw_hair_salon_custom_css .='padding-top: '.esc_attr($vw_hair_salon_topbar_padding_top_bottom).'; padding-bottom: '.esc_attr($vw_hair_salon_topbar_padding_top_bottom).';';
		$vw_hair_salon_custom_css .='}';
	}

	$vw_hair_salon_navigation_menu_font_size = get_theme_mod('vw_hair_salon_navigation_menu_font_size');
	if($vw_hair_salon_navigation_menu_font_size != false){
		$vw_hair_salon_custom_css .='.main-navigation a{';
			$vw_hair_salon_custom_css .='font-size: '.esc_attr($vw_hair_salon_navigation_menu_font_size).';';
		$vw_hair_salon_custom_css .='}';
	}

	$vw_hair_salon_nav_menus_font_weight = get_theme_mod( 'vw_hair_salon_navigation_menu_font_weight','Default');
    if($vw_hair_salon_nav_menus_font_weight == 'Default'){
		$vw_hair_salon_custom_css .='.main-navigation a{';
			$vw_hair_salon_custom_css .='';
		$vw_hair_salon_custom_css .='}';
	}else if($vw_hair_salon_nav_menus_font_weight == 'Normal'){
		$vw_hair_salon_custom_css .='.main-navigation a{';
			$vw_hair_salon_custom_css .='font-weight: normal;';
		$vw_hair_salon_custom_css .='}';
	}
	...
	if($vw_hair_salon_sticky_header_padding != false){
		$vw_hair_salon_custom_css .='.header-fixed{';
			$vw_hair_salon_custom_css .='padding: '.esc_attr($vw_hair_salon_sticky_header_padding).';';
		$vw_hair_salon_custom_css .='}';
	}
	...
	if($vw_hair_salon_search_padding_top_bottom != false || $vw_hair_salon_search_padding_left_right != false || $vw_hair_salon_search_font_size != false || $vw_hair_salon_search_border_radius != false){
		$vw_hair_salon_custom_css .='.search-box i{';
			$vw_hair_salon_custom_css .='padding-top: '.esc_attr($vw_hair_salon_search_padding_top_bottom).'; padding-bottom: '.esc_attr($vw_hair_salon_search_padding_top_bottom).';padding-left: '.esc_attr($vw_hair_salon_search_padding_left_right).';padding-right: '.esc_attr($vw_hair_salon_search_padding_left_right).';font-size: '.esc_attr($vw_hair_salon_search_font_size).';border-radius: '.esc_attr($vw_hair_salon_search_border_radius).'px;';
		$vw_hair_salon_custom_css .='}';
	}
	...
	if($vw_hair_salon_button_padding_top_bottom != false || $vw_hair_salon_button_padding_left_right != false){
		$vw_hair_salon_custom_css .='.blogbutton-small{';
			$vw_hair_salon_custom_css .='padding-top: '.esc_attr($vw_hair_salon_button_padding_top_bottom).'; padding-bottom: '.esc_attr($vw_hair_salon_button_padding_top_bottom).';padding-left: '.esc_attr($vw_hair_salon_button_padding_left_right).';padding-right: '.esc_attr($vw_hair_salon_button_padding_left_right).';';
		$vw_hair_salon_custom_css .='}';
	}
	...
	if($vw_hair_salon_button_border_radius != false){
		$vw_hair_salon_custom_css .='.blogbutton-small, .hvr-sweep-to-right:before{';
			$vw_hair_salon_custom_css .='border-radius: '.esc_attr($vw_hair_salon_button_border_radius).'px;';
		$vw_hair_salon_custom_css .='}';
	}
	...
	$vw_hair_salon_featured_image_border_radius = get_theme_mod('vw_hair_salon_featured_image_border_radius', 0);
	if($vw_hair_salon_featured_image_border_radius != false){
		$vw_hair_salon_custom_css .='.box-image img, .feature-box img{';
			$vw_hair_salon_custom_css .='border-radius: '.esc_attr($vw_hair_salon_featured_image_border_radius).'px;';
		$vw_hair_salon_custom_css .='}';
	}

	$vw_hair_salon_featured_image_box_shadow = get_theme_mod('vw_hair_salon_featured_image_box_shadow',0);
	if($vw_hair_salon_featured_image_box_shadow != false){
		$vw_hair_salon_custom_css .='.box-image img, .feature-box img, #content-vw img{';
			$vw_hair_salon_custom_css .='box-shadow: '.esc_attr($vw_hair_salon_featured_image_box_shadow).'px '.esc_attr($vw_hair_salon_featured_image_box_shadow).'px '.esc_attr($vw_hair_salon_featured_image_box_shadow).'px #cccccc;';
		$vw_hair_salon_custom_css .='}';
	}

	/*-------------- Copyright Alignment ----------------*/

	$vw_hair_salon_footer_background_color = get_theme_mod('vw_hair_salon_footer_background_color');
	if($vw_hair_salon_footer_background_color != false){
		$vw_hair_salon_custom_css .='.footer{';
			$vw_hair_salon_custom_css .='background-color: '.esc_attr($vw_hair_salon_footer_background_color).';';
		$vw_hair_salon_custom_css .='}';
	}

	$vw_hair_salon_copyright_font_size = get_theme_mod('vw_hair_salon_copyright_font_size');
	if($vw_hair_salon_copyright_font_size != false){
		$vw_hair_salon_custom_css .='.copyright p{';
			$vw_hair_salon_custom_css .='font-size: '.esc_attr($vw_hair_salon_copyright_font_size).';';
		$vw_hair_salon_custom_css .='}';
	}
	...
	if($vw_hair_salon_copyright_padding_top_bottom != false){
		$vw_hair_salon_custom_css .='.footer-2{';
			$vw_hair_salon_custom_css .='padding-top: '.esc_attr($vw_hair_salon_copyright_padding_top_bottom).'; padding-bottom: '.esc_attr($vw_hair_salon_copyright_padding_top_bottom).';';
		$vw_hair_salon_custom_css .='}';
	}

	$vw_hair_salon_copyright_alignment = get_theme_mod('vw_hair_salon_copyright_alignment');
	if($vw_hair_salon_copyright_alignment != false){
		$vw_hair_salon_custom_css .='.copyright p{';
			$vw_hair_salon_custom_css .='text-align: '.esc_attr($vw_hair_salon_copyright_alignment).';';
		$vw_hair_salon_custom_css .='}';
	}
	...
	if($vw_hair_salon_scroll_to_top_font_size != false){
		$vw_hair_salon_custom_css .='.scrollup i{';
			$vw_hair_salon_custom_css .='font-size: '.esc_attr($vw_hair_salon_scroll_to_top_font_size).';';
		$vw_hair_salon_custom_css .='}';
	}
	...
	if($vw_hair_salon_scroll_to_top_padding != false){
		$vw_hair_salon_custom_css .='.scrollup i{';
			$vw_hair_salon_custom_css .='padding-top: '.esc_attr($vw_hair_salon_scroll_to_top_padding).';padding-bottom: '.esc_attr($vw_hair_salon_scroll_to_top_padding).';';
		$vw_hair_salon_custom_css .='}';
	}
	...
	if($vw_hair_salon_scroll_to_top_width != false){
		$vw_hair_salon_custom_css .='.scrollup i{';
			$vw_hair_salon_custom_css .='width: '.esc_attr($vw_hair_salon_scroll_to_top_width).';';
		$vw_hair_salon_custom_css .='}';
	}
	...
	if($vw_hair_salon_scroll_to_top_height != false){
		$vw_hair_salon_custom_css .='.scrollup i{';
			$vw_hair_salon_custom_css .='height: '.esc_attr($vw_hair_salon_scroll_to_top_height).';';
		$vw_hair_salon_custom_css .='}';
	}
	...
	if($vw_hair_salon_scroll_to_top_border_radius != false){
		$vw_hair_salon_custom_css .='.scrollup i{';
			$vw_hair_salon_custom_css .='border-radius: '.esc_attr($vw_hair_salon_scroll_to_top_border_radius).'px;';
		$vw_hair_salon_custom_css .='}';
	}
	...
	if($vw_hair_salon_social_icon_font_size != false){
		$vw_hair_salon_custom_css .='.sidebar .custom-social-icons i, .footer .custom-social-icons i{';
			$vw_hair_salon_custom_css .='font-size: '.esc_attr($vw_hair_salon_social_icon_font_size).';';
		$vw_hair_salon_custom_css .='}';
	}
	...
	if($vw_hair_salon_social_icon_padding != false){
		$vw_hair_salon_custom_css .='.sidebar .custom-social-icons i, .footer .custom-social-icons i{';
			$vw_hair_salon_custom_css .='padding: '.esc_attr($vw_hair_salon_social_icon_padding).';';
		$vw_hair_salon_custom_css .='}';
	}
	...
	if($vw_hair_salon_social_icon_width != false){
		$vw_hair_salon_custom_css .='.sidebar .custom-social-icons i, .footer .custom-social-icons i{';
			$vw_hair_salon_custom_css .='width: '.esc_attr($vw_hair_salon_social_icon_width).';';
		$vw_hair_salon_custom_css .='}';
	}
	...
	if($vw_hair_salon_social_icon_height != false){
		$vw_hair_salon_custom_css .='.sidebar .custom-social-icons i, .footer .custom-social-icons i{';
			$vw_hair_salon_custom_css .='height: '.esc_attr($vw_hair_salon_social_icon_height).';';
		$vw_hair_salon_custom_css .='}';
	}
	...
	if($vw_hair_salon_social_icon_border_radius != false){
		$vw_hair_salon_custom_css .='.sidebar .custom-social-icons i, .footer .custom-social-icons i{';
			$vw_hair_salon_custom_css .='border-radius: '.esc_attr($vw_hair_salon_social_icon_border_radius).'px;';
		$vw_hair_salon_custom_css .='}';
	}
	...
	if($vw_hair_salon_products_padding_top_bottom != false){
		$vw_hair_salon_custom_css .='.woocommerce ul.products li.product, .woocommerce-page ul.products li.product{';
			$vw_hair_salon_custom_css .='padding-top: '.esc_attr($vw_hair_salon_products_padding_top_bottom).'!important; padding-bottom: '.esc_attr($vw_hair_salon_products_padding_top_bottom).'!important;';
		$vw_hair_salon_custom_css .='}';
	}
	...
	if($vw_hair_salon_products_padding_left_right != false){
		$vw_hair_salon_custom_css .='.woocommerce ul.products li.product, .woocommerce-page ul.products li.product{';
			$vw_hair_salon_custom_css .='padding-left: '.esc_attr($vw_hair_salon_products_padding_left_right).'!important; padding-right: '.esc_attr($vw_hair_salon_products_padding_left_right).'!important;';
		$vw_hair_salon_custom_css .='}';
	}
	...
	if($vw_hair_salon_products_box_shadow != false){
		$vw_hair_salon_custom_css .='.woocommerce ul.products li.product, .woocommerce-page ul.products li.product{';
				$vw_hair_salon_custom_css .='box-shadow: '.esc_attr($vw_hair_salon_products_box_shadow).'px '.esc_attr($vw_hair_salon_products_box_shadow).'px '.esc_attr($vw_hair_salon_products_box_shadow).'px #ddd;';
		$vw_hair_salon_custom_css .='}';
	}
	...
	if($vw_hair_salon_products_border_radius != false){
		$vw_hair_salon_custom_css .='.woocommerce ul.products li.product, .woocommerce-page ul.products li.product{';
			$vw_hair_salon_custom_css .='border-radius: '.esc_attr($vw_hair_salon_products_border_radius).'px;';
		$vw_hair_salon_custom_css .='}';
	}

	$vw_hair_salon_products_button_border_radius = get_theme_mod('vw_hair_salon_products_button_border_radius');
	if($vw_hair_salon_products_button_border_radius != false){
		$vw_hair_salon_custom_css .='.woocommerce ul.products li.product .button, a.checkout-button.button.alt.wc-forward,.woocommerce #respond input#submit, .woocommerce a.button, .woocommerce button.button, .woocommerce input.button, .woocommerce #respond input#submit.alt, .woocommerce a.button.alt, .woocommerce button.button.alt, .woocommerce input.button.alt{';
			$vw_hair_salon_custom_css .='border-radius: '.esc_attr($vw_hair_salon_products_button_border_radius).'px;';
		$vw_hair_salon_custom_css .='}';
	}

	$vw_hair_salon_woocommerce_sale_position = get_theme_mod( 'vw_hair_salon_woocommerce_sale_position','right');
    if($vw_hair_salon_woocommerce_sale_position == 'left'){
		$vw_hair_salon_custom_css .='.woocommerce ul.products li.product .onsale{';
			$vw_hair_salon_custom_css .='left: -10px; right: auto;';
		$vw_hair_salon_custom_css .='}';
	}else if($vw_hair_salon_woocommerce_sale_position == 'right'){
		$vw_hair_salon_custom_css .='.woocommerce ul.products li.product .onsale{';
			$vw_hair_salon_custom_css .='left: auto; right: 0;';
		$vw_hair_salon_custom_css .='}';
	}

	$vw_hair_salon_woocommerce_sale_font_size = get_theme_mod('vw_hair_salon_woocommerce_sale_font_size');
	if($vw_hair_salon_woocommerce_sale_font_size != false){
		$vw_hair_salon_custom_css .='.woocommerce span.onsale{';
			$vw_hair_salon_custom_css .='font-size: '.esc_attr($vw_hair_salon_woocommerce_sale_font_size).'!important;';
		$vw_hair_salon_custom_css .='}';
	}

	$vw_hair_salon_woocommerce_sale_border_radius = get_theme_mod('vw_hair_salon_woocommerce_sale_border_radius', 100);
	if($vw_hair_salon_woocommerce_sale_border_radius != false){
		$vw_hair_salon_custom_css .='.woocommerce span.onsale{';
			$vw_hair_salon_custom_css .='border-radius: '.esc_attr($vw_hair_salon_woocommerce_sale_border_radius).'px;';
		$vw_hair_salon_custom_css .='}';
	}
	...
	$vw_hair_salon_site_title_font_size = get_theme_mod('vw_hair_salon_site_title_font_size');
	if($vw_hair_salon_site_title_font_size != false){
		$vw_hair_salon_custom_css .='.logo h1 a, .logo p.site-title a{';
			$vw_hair_salon_custom_css .='font-size: '.esc_attr($vw_hair_salon_site_title_font_size).';';
		$vw_hair_salon_custom_css .='}';
	}

	// Site tagline Font Size
	$vw_hair_salon_site_tagline_font_size = get_theme_mod('vw_hair_salon_site_tagline_font_size');
	if($vw_hair_salon_site_tagline_font_size != false){
		$vw_hair_salon_custom_css .='p.site-description{';
			$vw_hair_salon_custom_css .='font-size: '.esc_attr($vw_hair_salon_site_tagline_font_size).';';
		$vw_hair_salon_custom_css .='}';
	}

	/*------------------ Preloader Background Color  -------------------*/

	$vw_hair_salon_preloader_bg_color = get_theme_mod('vw_hair_salon_preloader_bg_color');
	if($vw_hair_salon_preloader_bg_color != false){
		$vw_hair_salon_custom_css .='#preloader{';
			$vw_hair_salon_custom_css .='background-color: '.esc_attr($vw_hair_salon_preloader_bg_color).';';
		$vw_hair_salon_custom_css .='}';
	}

	$vw_hair_salon_preloader_border_color = get_theme_mod('vw_hair_salon_preloader_border_color');
	if($vw_hair_salon_preloader_border_color != false){
		$vw_hair_salon_custom_css .='.loader-line{';
			$vw_hair_salon_custom_css .='border-color: '.esc_attr($vw_hair_salon_preloader_border_color).'!important;';
		$vw_hair_salon_custom_css .='}';
	}