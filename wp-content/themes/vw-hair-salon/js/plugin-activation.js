jQuery(document).ready(function($) {
    'use strict';
    var this_obj = vw_hair_salon_plugin_activate_plugin;
    ...
    $(document).on('click', '.vw-hair-salon-plugin-install', function(event) {
        ...
        wp.updates.installPlugin({
            ...
            success: function(data) {
                ...
                button.removeClass('button-secondary updating-message vw-hair-salon-plugin-install');
                button.addClass('button-primary vw-hair-salon-plugin-activate');
                button.trigger('click');
            },
            error: function(data) {
                jQuery('.vw-hair-salon-recommended-plugins .vw-hair-salon-activation-note').css('display','block');
    ...
    $(document).on('click', '.vw-hair-salon-plugin-activate', function(event) {
    ...
    jQuery('#lite_theme .ibtana-skip-btn').click(function(){
        ...
        jQuery('#lite_theme .vw-hair-salon-recommended-plugins').css('display','none');
    });

    jQuery('#block_pattern .ibtana-skip-btn').click(function(){
        var light_theme = jQuery(this).attr('get-start-tab-id');
        jQuery('.' + light_theme).css('display','block');
        jQuery('#block_pattern .vw-hair-salon-recommended-plugins').css('display','none');
    });
